...
<qgis simplifyLocal="1" version="3.0.3-Girona" maxScale="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" simplifyAlgorithm="0" readOnly="0" minScale="1e+8" simplifyDrawingHints="1" simplifyDrawingTol="1">
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{515d87b3-6816-4ef0-a39f-d8db9ddc8372}">
      <rule scalemaxdenom="10000" scalemindenom="1" symbol="0" key="{752d33f4-cc4b-44e1-a2f7-700fca8a7db4}"/>
    </rules>
    <symbols>
      <symbol alpha="0.579" type="fill" name="0" clip_to_extent="1">
        <layer class="LinePatternFill" locked="0" pass="0" enabled="1">
          <prop v="90" k="angle"/>
          <prop v="118,105,98,255" k="color"/>
          ...
          <symbol alpha="1" type="line" name="@0@0" clip_to_extent="1">
            <layer class="SimpleLine" locked="0" pass="0" enabled="1">
              ...
              <prop v="157,140,131,255" k="line_color"/>
        ...
        <layer class="SimpleFill" locked="0" pass="0" enabled="1">
          ...
          <prop v="177,158,147,255" k="color"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="0,0" k="offset"/>
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MM" k="offset_unit"/>
          <prop v="242,228,210,255" k="outline_color"/>
