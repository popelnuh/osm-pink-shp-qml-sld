...
<qgis version="3.0.3-Girona" simplifyDrawingHints="1" simplifyMaxScale="1" minScale="1e+8" simplifyDrawingTol="1" maxScale="0" simplifyLocal="1" readOnly="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" labelsEnabled="0">
  <renderer-v2 enableorderby="0" type="RuleRenderer" forceraster="0" symbollevels="0">
    <rules key="{50d3457e-d6af-448e-9356-be7e90fbc4fa}">
      <rule label="Buildings 1:150,000 - 1:50,000" scalemindenom="50000" symbol="0" key="{011edacd-6a57-4a9c-a2cb-f1773a6032dc}" scalemaxdenom="150000"/>
      <rule label="Buildings 1:50,000 - 1:15,000" scalemindenom="15000" symbol="1" key="{cb225b9c-2951-4fd4-bf63-b8911dc22fe9}" scalemaxdenom="50000"/>
      <rule label="Buildings 1:15,000 - 1:10,000" scalemindenom="10000" symbol="2" key="{7fd7943f-ee73-4e60-8b53-35681fc84d0c}" scalemaxdenom="15000"/>
      <rule label="Buildings 1:10,000 - 1:5,000" scalemindenom="5000" symbol="3" key="{a7be51b8-03a2-4769-a088-af639b976e8a}" scalemaxdenom="10000"/>
      <rule label="Buildings 1:5,000 - 1:1" scalemindenom="1" symbol="4" key="{0d00272c-92c0-4132-b11b-ba15ea08a01e}" scalemaxdenom="5000"/>
    </rules>
    <symbols>
      <symbol clip_to_extent="1" type="fill" name="0" alpha="1">
        <layer pass="0" locked="0" enabled="1" class="SimpleFill">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="color" v="210,156,160,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="237,175,180,0"/>
            ...
            <Option type="Map">
              ...
              <Option type="Map" name="properties">
                <Option type="Map" name="fillColor">
                  ...
                  <Option type="QString" value="lighter(@symbol_color,randf(100,120))" name="expression"/>
      ...
      <symbol clip_to_extent="1" type="fill" name="1" alpha="1">
        <layer pass="0" locked="0" enabled="1" class="SimpleFill">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="color" v="237,175,180,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="237,175,180,255"/>
          <prop k="outline_style" v="solid"/>
          <prop k="outline_width" v="0.26"/>
          <prop k="outline_width_unit" v="MM"/>
          <prop k="style" v="solid"/>
      ...
      <symbol clip_to_extent="1" type="fill" name="2" alpha="1">
        <layer pass="0" locked="0" enabled="1" class="SimpleFill">
          ...
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="202,146,150,255"/>
          <prop k="outline_style" v="solid"/>
          <prop k="outline_width" v="0.26"/>
          <prop k="outline_width_unit" v="MM"/>
          <prop k="style" v="solid"/>
      ...
      <symbol clip_to_extent="1" type="fill" name="3" alpha="1">
        <layer pass="0" locked="0" enabled="1" class="SimpleFill">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="color" v="202,146,150,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0.20000000000000001,0.20000000000000001"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
        ...
        <layer pass="0" locked="0" enabled="1" class="SimpleFill">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="color" v="235,169,172,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
      ...
      <symbol clip_to_extent="1" type="fill" name="4" alpha="1">
        <layer pass="0" locked="0" enabled="1" class="SimpleFill">
          ...
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="160,143,136,255"/>
          <prop k="outline_style" v="solid"/>
          <prop k="outline_width" v="0.26"/>
          <prop k="outline_width_unit" v="MM"/>
          <prop k="style" v="solid"/>
