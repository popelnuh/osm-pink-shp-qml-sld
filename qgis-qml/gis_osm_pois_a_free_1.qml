...
<qgis version="3.0.3-Girona" simplifyDrawingHints="1" simplifyMaxScale="1" minScale="1e+8" simplifyDrawingTol="1" maxScale="0" simplifyLocal="1" readOnly="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" labelsEnabled="1">
  <renderer-v2 enableorderby="0" type="RuleRenderer" forceraster="0" symbollevels="0">
    <rules key="{f1678b2f-06d6-45ae-ac23-b5e1a41c64c1}">
      <rule label="Places of Interest, 100,000 - 1:1" scalemindenom="1" symbol="0" filter=" &quot;fclass&quot; IN ( 'archaeological' , 'golf_course' ,  'monument' , 'picnic_site' , 'playground' , 'zoo', 'hospital', 'attraction' ,  'embassy' , 'museum' ,'theatre')" key="{cdb32965-9d19-424b-8d8b-6ffc088cc7d7}" scalemaxdenom="100000"/>
    </rules>
    <symbols>
      <symbol clip_to_extent="1" type="fill" name="0" alpha="1">
        <layer pass="0" locked="0" enabled="1" class="SimpleFill">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="color" v="252,243,226,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="252,243,226,255"/>
  ...
  <labeling type="rule-based">
    <rules key="{30a3a93c-d6ae-4874-9fa1-ac9a307ae1b7}">
      <rule filter="&quot;name&quot;" key="{2512c25f-8a44-4150-98dd-6471e49a9e66}">
        <settings>
